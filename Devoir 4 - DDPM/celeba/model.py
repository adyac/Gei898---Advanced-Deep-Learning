...
class ResnetBlock_Cas1(nn.Module):
...
class UnetCas1(nn.Module):
    """U-Net where every ResNet block is replaced by ResnetBlock_Cas1.
    ...
    def forward(self, x, time, cond):
        ...
        Args:
            ...
            cond: [B, cond_dim]  — condition c' from encode()
        """
        x = self.init_conv(x)
        r = x.clone()
